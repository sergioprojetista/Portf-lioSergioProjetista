...
export const PROJECTS: ProjectCase[] = [
  {
    ...
    challenge: 'Componente hidráulico com 6 faces de fixação distintas e geometria complexa. Sem gabarito dedicado, a linha registrava 8% de rejeição e setup acima de 40 minutos por operador.',
    solution: 'Dispositivo completo com estrutura em portal, fixações pneumáticas simultâneas, posicionadores cônicos e placa-base modular. Projetado no SolidWorks com simulação de interferência e folgas de usinagem. 42 componentes integrados, todos em conformidade NR-12.',
    technicalSpecs: {
    ...
    results: [
      'Setup reduzido de 40 min para 6 min — queda de 85%',
      'Zero rejeição desde a implantação',
  ...
  },
  {
    ...
    results: [
      'Aumento de 40% na produtividade horária',
      'Eliminação de erros de posicionamento manual',
      'Compatibilidade com 4 modelos de eixos',
    ],
  ...
  },
  {
    ...
    technicalSpecs: {
      software: ['SolidWorks', 'Simulação de Elementos Finitos'],
    ...
    results: [
      ...
      'Setup simplificado para operador',
    ],
  ...
  },
  {
    ...
    technicalSpecs: {
      software: ['SolidWorks', 'Integração de Sensores'],
      tolerances: '± 0.05mm em montagem modular',
      standards: ['NR-12', 'CE'],
      partCount: 64,
    },
    results: [
      'Sistema modular adaptável a variações de projeto',
      'Monitoramento em tempo real de fixação',
      'Redução de 50% no lead time de montagem',
    ],
